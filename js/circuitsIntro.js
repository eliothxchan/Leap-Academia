$(document).ready(function(){
  ...
  $('#voltageAnswer').css("left", 4*height_grid + 10 + "px");
  $('#currentAnswer').css("left", 4*width_grid + 10 + "px");
  $('#currentAnswer').css("top", 4*height_grid + 10 + "px");
  $('#resistanceAnswer').css("left", 4*height_grid + 10 + "px");
  $('#resistanceAnswer').css("top", 4*height_grid + 10 + "px");
});